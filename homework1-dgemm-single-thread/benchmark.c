...
int main (int argc, char **argv)
{
 ...
 { 127,128,129,255,256,257,383,384,385,511,512,513,639,640,641,767,768,769,895,896,897,1023,1024,1025,1151,1152,1153,1279,1280,1281 };
  ...
  int nmax = 1 << (int) ceil(log2(test_sizes[nsizes-1]));
